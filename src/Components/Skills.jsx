...
//       <h1 className='Skills-Heading-Style'>My Skills</h1>
//       <p className='Skills-para-style'>What i Know</p>
//       <div className='skills-ul-li-style'>
//         <nav>
//             <ul>
//                 <li>I got goodknowledge in react</li>
//                 <li>Adapting to new technologies is easy and ill learn quickly.</li>
//                 <li>For fetching axios and react fetch ill use.</li>
//                 <li>I will use for Boostrap.</li>
//                 <p className='Known-style'>Known Packages:</p>
//                 <li>npm packages is used for React </li>
//                 <p className='library-style'>Known Library:</p>
//                 <li>React-Bootstrap</li>
//             </ul>
//         </nav>
//         <button type="button" className='MoveTop-Style'>Move Top</button>
//       </div>
//     </div>
//     </>
//   )
...
import SkillsStatus from './SkillsStatusBar';
