...
// import MyResumeImgs from '../assets/Images/resume-pic.jpg';
...
//           <li><a href="#About Me" onClick={handleScrollToAbout}>About</a></li>
//           <li><a href="#">Skills</a></li>
//           <li><a href="#">Projects</a></li>
//           <li><a href="#">Contact</a></li>
//           <li><img src={MyResumeImgs} className='resume-Css' alt="resume-pic" /></li>
//         </ul>
//       </nav>
//       <div className='Heading-Type' id='about'>
